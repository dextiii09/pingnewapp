...
// ... (Sub-modals remain unchanged, omitted for brevity but would be included in full file) ...
// INCLUDING SUB-MODALS FOR COMPLETE FILE REPLACEMENT TO AVOID ERRORS
        ...
        <div className="p-2">
           {[
             ...
             <div key={item.key} className="flex items-center justify-between p-4 hover:bg-black/5 dark:hover:bg-white/5 rounded-xl transition-colors">
                ...
                <Toggle active={settings[item.key as keyof typeof settings]} onToggle={() => toggle(item.key as keyof typeof settings)} />
             </div>
           ))}
        </div>
      </motion.div>
...
export const SettingsView: React.FC<SettingsViewProps> = ({ onBack, onLogout, onUpgrade, isDarkMode, onToggleTheme }) => {
  // Modal States
  const [activeModal, setActiveModal] = useState<'none' | 'safety' | 'notifications' | 'payment' | 'blocked' | 'delete'>('none');
  ...
  return (
    <div className="h-full flex flex-col p-6 animate-in slide-in-from-right duration-300 relative text-gray-900 dark:text-white bg-white dark:bg-[#050505]">
      ...
      <div className="flex-1 overflow-y-auto space-y-8 pb-24 no-scrollbar">
        ...
        <div className="space-y-3">
           ...
           <GlassCard className="p-0 overflow-hidden" intensity="low">
              ...
              <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <span className="text-xs text-gray-500 dark:text-white/50 block">New York, NY</span>
                   </div>
                 </div>
                 <Button variant="ghost" className="h-8 text-xs text-blue-500">Update</Button>
              </div>
              ...
              <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
                 ...
                 <Toggle active={globalMode} onToggle={() => setGlobalMode(!globalMode)} />
              </div>

              {/* Distance Slider (Conditional) */}
              {!globalMode && (
              ...
              <div className="w-full flex items-center justify-between p-4">
                 ...
                 <Toggle active={isVisible} onToggle={() => setIsVisible(!isVisible)} />
              </div>
           </GlassCard>
        </div>
        ...
        <div className="space-y-3">
          ...
          <GlassCard className="p-0 overflow-hidden" intensity="low">
            ...
            <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
               ...
               <Toggle active={haptics} onToggle={() => setHaptics(!haptics)} />
            </div>
            ...
            <button onClick={cycleLanguage} className="w-full flex items-center justify-between p-4 hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
               ...
               <div className="flex items-center gap-2">
                 <span className="text-xs text-gray-500 dark:text-white/40">{language}</span>
                 <ChevronRight size={16} className="text-gray-300 dark:text-white/20" />
               </div>
            </button>
          </GlassCard>
           ...
           <GlassCard className="p-0 overflow-hidden" intensity="low">
              <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                     ...
                     <span className="text-xs text-green-500 font-medium block">Connected as @user</span>
                   </div>
                 </div>
              ...
              <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
                 <div className="flex items-center gap-3">
                   ...
                   <span className="text-sm font-medium text-gray-900 dark:text-white/90">X (Twitter)</span>
                 </div>
                 <Button variant="secondary" className="h-7 text-xs px-3">Connect</Button>
              </div>
              <div className="w-full flex items-center justify-between p-4">
                 <div className="flex items-center gap-3">
                   <div className="w-9 h-9 rounded-full bg-[#0077b5] text-white flex items-center justify-center"><Linkedin size={18} /></div>
                   <span className="text-sm font-medium text-gray-900 dark:text-white/90">LinkedIn</span>
                 </div>
                 <Button variant="secondary" className="h-7 text-xs px-3">Connect</Button>
              </div>
           </GlassCard>
        ...
        <div className="space-y-3">
           ...
           <GlassCard className="p-0 overflow-hidden" intensity="low">
              ...
              <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
                 ...
                 <Toggle active={onlineStatus} onToggle={() => setOnlineStatus(!onlineStatus)} />
              </div>
              ...
              <div className="w-full flex items-center justify-between p-4 border-b border-black/5 dark:border-white/5">
                 ...
                 <Toggle active={readReceipts} onToggle={() => setReadReceipts(!readReceipts)} />
              </div>
        ...
        <div className="space-y-3">
          ...
          <GlassCard className="p-0 overflow-hidden" intensity="low">
            ...
            <button className="w-full flex items-center justify-between p-4 hover:bg-black/5 dark:hover:bg-white/5 transition-colors border-b border-black/5 dark:border-white/5 group">
               <div className="flex items-center gap-3">
      ...
      <AnimatePresence>
        ...
        {activeModal === 'notifications' && <NotificationSettingsModal onClose={() => setActiveModal('none')} />}
