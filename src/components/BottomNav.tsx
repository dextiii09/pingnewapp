          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.div
                  layoutId="nav-pill"
                  className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-orange-500/10 dark:bg-white/10 rounded-full"
              ...
              {isActive && (
                <motion.div 
                  layoutId="nav-dot"
                  className="absolute bottom-2 w-1.5 h-1.5 bg-pink-500 rounded-full"
                  transition={{ type: "spring", stiffness: 500, damping: 30 }}
                />
              )}
            </motion.button>
